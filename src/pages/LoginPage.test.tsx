...
import { apiLoginUser } from '../services/api'; // <-- CORREÇÃO 1: Importado 'apiLoginUser'
...
    const user = userEvent.setup();
    // <-- CORREÇÃO 2: Usando 'apiLoginUser'
    (apiLoginUser as jest.Mock).mockRejectedValueOnce(new Error('Falha no login')); 
    
    render(<MemoryRouter><App /></MemoryRouter>);
...
    const fakeToken = 'fake-jwt-token';
    // <-- CORREÇÃO 2: Usando 'apiLoginUser'
    (apiLoginUser as jest.Mock).mockResolvedValueOnce({ token: fakeToken }); 
